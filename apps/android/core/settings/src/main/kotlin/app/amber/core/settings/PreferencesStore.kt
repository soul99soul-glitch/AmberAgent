...
- For webpage tasks:
  - If WebView tools are available and the user asks to open, browse, view, inspect, or visually verify a webpage, call webview_open early so the live preview shows the page.
