...
data class MiniAppEntity(
    ...
    val runCount: Int = 0,
    /**
     * P3-04: UI projection only — NOT the persisted source of truth for
     * MiniApp content. `host.createArtifact` content lives in the Workspace
     * Artifact Registry (sourceKind=miniapp); this field is kept for backward
     * compatibility and read-side display, and must not be relied on for
     * durable content.
     */
