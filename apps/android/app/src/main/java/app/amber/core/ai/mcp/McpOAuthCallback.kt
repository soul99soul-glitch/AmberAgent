...
/**
 * OAuth 授权回调的 redirect_uri，需与 AndroidManifest 中
 * McpOAuthCallbackActivity 的 intent-filter 保持一致。
 */
const val MCP_OAUTH_REDIRECT_URI = "amberagent://mcp-oauth-callback"
