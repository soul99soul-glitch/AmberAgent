...
sealed class ProviderSetting {
    ...
    data class OpenAI(
        ...
        /**
         * P6-01: user-level switch for server-side stored Responses + resume.
         * Only meaningful (and only shown in the settings UI) when
         * [supportsResponsesResume] holds — strict official endpoint + API
         * key + Responses API. Off keeps store=false (today's behavior).
         */
        var enableResponsesResume: Boolean = false,
