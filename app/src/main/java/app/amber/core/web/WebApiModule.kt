...
import app.amber.core.web.dto.ErrorResponse
import app.amber.core.web.dto.WebAuthTokenRequest
import app.amber.core.web.dto.WebAuthTokenResponse
import app.amber.core.web.routes.aiIconRoutes
import app.amber.core.web.routes.assetsRoutes
import app.amber.core.web.routes.conversationRoutes
import app.amber.core.web.routes.filesRoutes
import app.amber.core.web.routes.settingsRoutes
import java.security.MessageDigest
import java.util.Date
import java.util.UUID

private const val WEB_JWT_ISSUER = "amber-agent-web"
private const val WEB_JWT_AUDIENCE = "amber-agent-web-client"
...
private const val WEB_AUTH_REALM = "amber-agent-web-api"
