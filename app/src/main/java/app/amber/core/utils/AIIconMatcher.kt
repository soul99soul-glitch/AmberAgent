...
fun computeAIIconByName(name: String): String? {
    ...
    val result = when {
        ...
        PATTERN_FISH.containsMatchIn(lowerName) -> "fish-audio.svg"
        PATTERN_LONGCAT.containsMatchIn(lowerName) -> "longcat-color.svg"
        PATTERN_AMBERAGENT.containsMatchIn(lowerName) -> "graphite_agent_mark"
...
private val PATTERN_AMBERAGENT = Regex("amberagent|auto")
...
private val PATTERN_FISH = Regex("fish")
