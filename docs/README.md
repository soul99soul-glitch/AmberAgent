...
- [`superpowers/specs/2026-08-16-novel-markdown-workspace-design.md`](superpowers/specs/2026-08-16-novel-markdown-workspace-design.md)：小说书/账本 + 薄 VCS；会话留账本（方案 A）；五阶段最小闭环已落地，JSON 仍为权威，代笔抽取未拆（Active）。
