...
final class IOSNovelCreationWiringTests: XCTestCase {
    ...
    func testProjectTitleOpensWritingAndHierarchicalContextSheet() throws {
        ...
        XCTAssertTrue(sheets.contains("Text(\"代笔看板\")"))
        XCTAssertTrue(sheets.contains("Text(\"代笔推进\")"))
        XCTAssertTrue(sheets.contains("Text(\"下一弧\")"))
    ...
    func testProjectSettingsExposeIndependentCreationAndSyncModels() throws {
        ...
        XCTAssertTrue(settings.contains("用于代笔合同验收与连续性检查"))
        XCTAssertTrue(settings.contains("审稿用于合同验收与连续性检查"))
